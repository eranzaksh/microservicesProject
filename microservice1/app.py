...
def is_valid_timestream(ts) -> bool:
    ...
    try:
        ...
        ts_int = int(ts)
        # Check for a reasonable range (years 1970–2100) assuming emails can be schedule for later then present time.
        if ts_int < 0 or ts_int > 4102444800:  # 4102444800 = 2100-01-01 00:00:00 UTC which is the maximum
            return False
